...
不变量:relatedIds 派生自 synapse(双向)。`,
  ...
  "viewer.help.tabStats":
    "<strong>概览</strong>—核心 KPI(印迹/突触/技能/检索,含本周增量)+ 30 天记忆脉搏 + 记忆动态(审计事件时间线)+ 右侧 TOP 榜卡(领域热度/检索热点/冷却记忆/贡献者,点击卡片展开 TOP 20)。顶部搜索框做全文检索。导航在左侧栏:高频入口在上,进化入口居中,体检/合并/配置/帮助收进底部图标行。",
