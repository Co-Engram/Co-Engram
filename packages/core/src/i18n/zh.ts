...
返回:Synapse 列表(出边/入边/双向),含 kind、weight。`,
  ...
  // ===== 技能退役提案(proposal.skillRetire.*,light 周期生成、提案中心展示) =====
  "proposal.skillRetire.title": "退役技能 ${skillId}(零调用 ${days} 天)",
  "proposal.skillRetire.content":
    "该技能自 ${createdAt} 注册以来零调用,已连续 ${days} 天未使用且 retentionStage=${stage}。建议退役:从 skill_list 与系统提示注入清单移除,释放注意力预算;源 SKILL.md 与印迹保留(skill_get 仍可查,一次真实使用即复活并自动撤销本提案)。accept=退役;dismiss=保留并重置计时。",
...
返回:Skill 元信息(name、description、template kind、parameters)。`,
  "tool.skill_invoke.agent": `报告一次 Skill 使用结果，用 Rescorla-Wagner 更新 utility + retention。**本工具只记录使用、不执行 skill**——实际执行由宿主完成；agent 用完 skill 后调用本工具报告结果，让技能印迹随使用演化。forgotten 或 retired（退役）的 skill 经一次使用报告自动复活（使用是最强的再激活信号；久未使用建议先复核 SKILL.md）。
...
返回:创建的 skill 记录,utility=0.5、acquisitionStage=draft、retentionStage=active。`,
  "tool.skill_list.agent": `列出所有 skill,可按习得深度/时间强度过滤;已退役(retired)的默认不列出,传 includeRetired: true 可含退役项(审计用)。
...
不变量:relatedIds 派生自 synapse(双向)。`,
  ...
  "engrams.tree.expandAll": "展开全部",
  "engrams.tree.collapseAll": "折叠全部",
  "viewer.nav.evolution": "进化",
  "viewer.tab.stats": "统计",
  ...
  "viewer.page.config.sub": "持久化配置(dataRoot .co-engram/config.json)",
  "viewer.tab.config": "配置",
  "viewer.tab.help": "帮助",
  "viewer.tab.merges": "团队记忆合并",
  "viewer.tab.health": "记忆健康检查",
  ...
  "enum.acquisitionStage.draft": "认知期",
  "enum.acquisitionStage.compiled": "熟练期",
  "enum.acquisitionStage.tuned": "精通期",
  ...
  "viewer.stats.feedLoading": "正在加载更早的动态…",
  ...
  "viewer.stats.retrievalTotal": "印迹检索",
  "viewer.stats.effectiveRate": "被检索率 ${pct}%",
  "viewer.stats.skillInvocations": "技能调用",
  "viewer.stats.skillInvocationsTip":
    "技能记忆累计调用次数(成功 + 失败),点击查看技能 tab",
  "viewer.stats.skillSuccessRate": "成功率 ${pct}%",
  "viewer.stats.domainHeat": "领域热度",
  "viewer.stats.domainHeatSub": "按印迹数",
  "viewer.stats.monthlyHot": "检索热点",
  "viewer.stats.monthlyHotSub": "检索次数 TOP",
  "viewer.stats.monthlyCool": "冷却记忆",
  "viewer.stats.monthlyCoolSub": "最久未取用 · 重要度最低",
  "viewer.stats.retrievalsShort": "${n} 次",
  "viewer.stats.daysAgo": "${n} 天前",
  "viewer.stats.neverRetrieved": "从未取用",
  "viewer.stats.contributorRanking2": "贡献数量排行",
  "viewer.stats.contributorHeat": "贡献热度排行",
  "viewer.stats.contributorHeatSub": "记忆被检索 + 技能被调用",
  "viewer.stats.heatRetrievalsShort": "检索 ${n}",
  "viewer.stats.heatSkillShort": "调用 ${n}",
  "viewer.stats.dayPopupTitle": "${date} 的记忆更新",
  "viewer.stats.dayPopupEmpty": "当日没有新增或内容更新",
  "viewer.stats.itemEngram": "印迹",
  ...
  "viewer.stats.totalSkills": "技能记忆总数",
  "viewer.stats.totalSkillsTip": "程序性记忆(skill)总数,点击查看技能 tab",
  "viewer.stats.clickToViewSkills": "点击查看技能",
  "viewer.stats.skillAcquisitionDistribution": "技能 · 按习得深度分布",
  "viewer.stats.skillRetentionDistribution": "技能 · 按保留阶段分布",
  ...
  "viewer.proposals.rem.scene.tagRefresh": "梦境·标签刷新",
  "viewer.proposals.rem.tagRefresh.from": "当前标签",
  ...
  "viewer.proposals.sourceLine.skill": "技能提案",
  "viewer.proposals.sourceLine.remInsight": "夜思洞察",
  "viewer.proposals.sourceLine.remInsightContemplation": "沉思洞察",
  "viewer.proposals.sourceLine.remPattern": "模式提炼",
  "viewer.proposals.sourceLine.remSynapse": "突触建议",
  "viewer.proposals.sourceLine.remTagRefresh": "标签刷新",
  "viewer.proposals.sourceLine.remVerification": "存活校验",
  ...
  "viewer.proposals.why.sourceLabel.remInsight": "夜思洞察",
  "viewer.proposals.why.sourceLabel.remInsightContemplation": "沉思洞察",
  "viewer.proposals.why.window.within": "${dur} 内 ${n} 次出现",
  "viewer.proposals.why.window.minute": "分钟",
  "viewer.proposals.why.window.hour": "小时",
  "viewer.proposals.why.window.day": "天",
  "viewer.proposals.why.advanced": "高级",
  "viewer.proposals.why.advancedReason": "原始评估理由",
  "viewer.proposals.why.advancedRule": "触发规则",
  ...
  "viewer.proposals.selectTip": "勾选后可批量采纳 / 驳回",
  "viewer.proposals.batch.acceptSelected": "采纳选中(${n})",
  "viewer.proposals.batch.dismissSelected": "驳回选中(${n})",
  "viewer.proposals.batch.clearSelection": "清除选择",
  "viewer.proposals.batch.acceptSelectedConfirm":
    "确认采纳选中的 ${n} 条提案?将创建对应记忆,不可撤销。",
  "viewer.proposals.batch.dismissSelectedConfirm":
    "确认驳回选中的 ${n} 条提案?驳回后 5 秒内可撤销。",
  "viewer.proposals.batch.acceptToast": "已采纳 ${ok} 条,失败 ${fail} 条",
  "viewer.proposals.batch.dismissToast": "已驳回 ${ok} 条,失败 ${fail} 条",
  "viewer.proposals.batch.undo": "撤销(${n})",
  ...
  "viewer.audit.filter.time": "时间",
  "viewer.audit.timeAll": "全部时间",
  "viewer.audit.timeToday": "今天",
  "viewer.audit.time7d": "近 7 天",
  "viewer.audit.time30d": "近 30 天",
  ...
  "viewer.audit.actionLabel.create": "创建",
  "viewer.audit.actionLabel.update": "更新",
  "viewer.audit.actionLabel.update_lifecycle": "状态迁移",
  "viewer.audit.actionLabel.importance_update": "重要性更新",
  "viewer.audit.actionLabel.reinforce": "强化",
  "viewer.audit.actionLabel.report_failure": "负反馈",
  "viewer.audit.actionLabel.learning_loop_success": "学习闭环",
  "viewer.audit.actionLabel.forget": "遗忘",
  "viewer.audit.actionLabel.restore": "恢复",
  "viewer.audit.actionLabel.sweep_to_trash": "移入回收站",
  "viewer.audit.actionLabel.restore_from_trash": "还原",
  "viewer.audit.actionLabel.purge": "清除",
  "viewer.audit.actionLabel.retrieve_hit": "检索命中",
  "viewer.audit.actionLabel.retrieve_effective": "检索生效",
  "viewer.audit.actionLabel.retrieve_inconclusive": "检索存疑",
  "viewer.audit.actionLabel.contradicted": "冲突",
  "viewer.audit.actionLabel.noise_filtered": "噪声过滤",
  "viewer.audit.actionLabel.necessity_rejected": "必要性驳回",
  "viewer.audit.actionLabel.propose": "提案",
  "viewer.audit.actionLabel.accept": "采纳",
  "viewer.audit.actionLabel.dismiss": "驳回",
  "viewer.audit.actionLabel.merge_resolved": "合并裁决",
  "viewer.audit.actionLabel.merge_backup_failed": "备份失败",
  "viewer.audit.actionLabel.merge_conflict_escalated": "合并冲突",
  ...
  "viewer.audit.actionLabel.skill_create": "创建技能",
  "viewer.audit.actionLabel.skill_update": "更新技能",
  "viewer.audit.actionLabel.skill_delete": "删除技能",
  "viewer.audit.actionLabel.skill_invoke": "调用技能",
  "viewer.audit.actionLabel.skill_compose_add": "组合技能",
  "viewer.audit.actionLabel.skill_compose_remove": "取消组合",
  ...
  "viewer.trash.purgeFailed": "彻底清除失败:${err}",
  ...
  "viewer.maintenance.sleep.decayDeep": "合并整理",
  ...
  "viewer.maintenance.sleep.decayDeepSub": "deep · 重复合并(卡片可看 from → to);陈旧记忆的归档/遗忘见右格",
  ...
  "viewer.maintenance.sleep.nextOverdue": "下次维护:${stage} 已过期,引擎空闲时补跑",
  ...
  "viewer.graph.insp.skillNode": "技能节点(程序性记忆)",
  "viewer.graph.insp.openFull": "打开全文",
  "viewer.graph.insp.auditTrail": "审计轨迹",
  "viewer.graph.insp.back": "Esc 返回",
  "viewer.graph.insp.retrieval": "取用",
  "viewer.graph.insp.never": "从未",
  "viewer.graph.insp.cluster": "所属簇",
  ...
  "viewer.help.tabStats":
    "<strong>概览</strong>—核心 KPI(印迹/突触/技能/检索,含本周增量)+ 30 天记忆脉搏 + 记忆动态(审计事件时间线,含 git 同步而来的团队成员操作)+ 右侧 TOP 榜卡(领域热度/检索热点/冷却记忆/贡献者,点击卡片展开 TOP 20)。顶部搜索框做全文检索。导航在左侧栏:高频入口在上,进化入口居中,体检/合并/配置/帮助收进底部图标行。",
  ...
  "viewer.help.profilesBody":
    "<strong>三档 profile</strong> 按用途收缩 LLM 工具表面,各档工具数见源码 <code>PROFILE_TOOL_COUNTS</code>(经 <code>.size</code> 自动算出,不会漂移)。<strong>minimal</strong>:核心读写 + proposal 处理三件套 + <code>engram_sync</code> —— 只做回忆和记录的 chat agent。<strong>standard(默认)</strong>:加上学习回路、矛盾仲裁、自愈(<code>engram_doctor</code>)、渐进式披露(<code>engram_list_paths</code>)、LLM 综合(<code>engram_synthesize</code>)与审计查询(<code>engram_audit_query</code>),以及批量提案清理(<code>engram_accept_proposals_by_source</code> / <code>engram_dismiss_proposals_by_filter</code>)。<strong>full(全量)</strong>:全部原生工具。切换:<code>CO_ENGRAM_TOOLS_PROFILE=minimal|standard|full</code>;无效值会告警并回退到 standard。",
  ...
  // ===== Skill 记忆(viewer.help.skill.*) =====
  "viewer.help.skillTitle": "Skill 记忆(程序性记忆)",
  "viewer.help.skillIntro":
    "<strong>Skill 记忆</strong>是 Co-Engram 的<strong>程序性记忆</strong>系统——对应人类记忆中的「怎么做」(knowing-how),与 engram 的「是什么」(knowing-what,陈述性记忆)形成互补。Skill 记忆科学的根基来自 <strong>ACT-R 认知架构</strong>,用 <strong>utility(效用)</strong>、<strong>retention(保持)</strong> 与 <strong>Options三元组</strong> 捕捉技能习得与使用过程。",
  ...
  "viewer.help.skill.retention":
    "<strong>retention(保持)</strong>:反映技能在记忆中的保持强度,按遗忘曲线随时间衰减(用过没用的技能距上次使用、从未使用的技能距注册时间起算),分 4 档:<code>active(活跃)</code>:近期使用频繁,保持强度高。<code>aging(老化)</code>:开始遗忘但仍可召回。<code>stale(陈旧)</code>:保持强度低,可能需重新学习。<code>forgotten(遗忘)</code>:已从默认技能池移除;<strong>使用一次即自动复活</strong>(relearning,下次 agent 触发时正常调用并报告即可),也可在网页上手动恢复。另有独立的<strong>退役态(retired)</strong>:用户 accept 退役提案后的裁决状态(非衰减投影),技能从 skill_list 与注入清单移除,skill_get 仍可查、使用即复活。",
  ...
  "viewer.help.skill.sidecar":
    "<strong>sidecar 存储</strong>:skill 的使用印迹(调用历史、utility 演化、参数模式等)存储在 <code><skill-dir>/.co-engram/imprint.json</code>,与 <code>SKILL.md</code> 分离。imprint.json 由系统自动维护,用户不应手动编辑——它保留完整的时间序列,用于 utility 计算与 retention 衰退。<code>SKILL.md</code> 只保留技能定义(输入/输出/参数/示例),由用户维护。这种分离让技能内容与使用历史解耦,Git 合并时不会因印迹数据产生冲突。",
  "viewer.help.skill.d11":
    "<strong>D11 分发规则</strong>:当 team-memory 仓库中有 skill 被分发到宿主工作目录时,如果宿主目录已有同名 skill,以<strong>本地 skill 为主</strong>,不覆盖。原则是「本地优先」——工作目录的 skill 是用户当前正在使用的版本,即使远端有更新也应保留本地修改。如需同步远端变更,用户需手动合并或显式接受远端版本。这避免误覆盖本地调优的 skill,保护用户的个性化配置。",
  ...
  "viewer.skill.openDir": "打开目录",
  "viewer.skill.openDirOpened": "已打开该技能所在的目录",
  "viewer.skill.openDirFailed": "打开目录失败:${err}",
  ...
  "skills.relatedCount": "关联记忆 ×${n}",
  "skills.successCountN": "成功 ${n}",
  "skills.failureCountN": "失败 ${n}",
  "skills.successCount": "成功",
  "skills.failureCount": "失败",
  "skills.invocationCount": "调用",
  "skills.successRate": "成功率",
  "skills.successRate.tip": "成功次数 / (成功 + 失败)",
  "skills.lowConfidence": "样本不足",
  "skills.lowConfidence.tip": "调用次数 < 3,utility 仅供参考",
  "skills.decayRisk": "衰退风险",
  "skills.decayRisk.soonAging": "{days} 天未用,即将衰退",
  "skills.decayRisk.aging": "渐衰,建议尽快使用以强化",
  "skills.decayRisk.stale": "过时,建议复习或遗忘",
  "skills.decayRisk.forgotten": "已遗忘(可恢复)",
  "viewer.skill.detailTitle": "技能详情",
