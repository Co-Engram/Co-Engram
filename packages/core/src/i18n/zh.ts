...
不变量:relatedIds 派生自 synapse(双向)。`,
  ...
  "tip.acquisitionStage.draft": "草稿 (draft)：新创建的 skill，尚未经使用验证。习得深度最低。",
  "tip.acquisitionStage.compiled": "已编译 (compiled)：经过使用验证，从草稿编译而来。",
  "tip.acquisitionStage.tuned": "已调优 (tuned)：经过充分使用和调优，习得深度最高。",
