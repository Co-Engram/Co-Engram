...
Invariant: relatedIds derived from synapses (both directions).`,
  ...
  "viewer.incubations.webOptInHint": "If checked, the question summary is sent to search engines; otherwise thinking is fully offline",
  "viewer.incubations.createBtn": "Seed",
  "viewer.incubations.l2BudgetNotice": "Night thinking calls an external LLM (may consume significant tokens). The L2 session process (plan/trace) is fully transparent; web research is off by default.",
  ...
  "viewer.stats.pulseTitle": "Memory Pulse",
  "viewer.stats.pulseSub": "daily new engrams · last 30 days",
  ...
  "viewer.stats.effectiveRate": "${pct}% effective",
  ...
  "viewer.stats.contributorRanking2": "Top Contributors",
  ...
  "viewer.graph.modes.title": "Color mode",
  "viewer.graph.modes.structure": "Structure",
  "viewer.graph.modes.vitality": "Vitality",
  "viewer.graph.modes.conflict": "Conflict",
  "viewer.graph.modes.heat": "Heat",
  "viewer.graph.modes.heatTitle": "Color by retrieval heat",
  ...
  "viewer.graph.reading.hint": "Size = importance · color = mode<br>glow = importance ≥0.7 · red dashed = invalidated edge<br>hover highlights edges · click focuses neighborhood · Esc returns",
