...
Invariant: relatedIds derived from synapses (both directions).`,
  ...
  "enum.policyKind.prompt": "Prompt",
  "enum.policyKind.claude-skill": "Claude skill",
  "enum.policyKind.openclaw-skill": "OpenClaw skill",
  "enum.policyKind.code": "Code",
  "enum.policyKind.workflow": "Workflow",
  ...
  "viewer.proposals.skill.policyKindLabel": "Execution policy",
  ...
  "tip.acquisitionStage.draft": "Draft: newly created skill, not yet validated through use. Lowest acquisition depth.",
  "tip.acquisitionStage.compiled": "Compiled: validated through use, promoted from draft.",
  "tip.acquisitionStage.tuned": "Tuned: thoroughly used and optimized. Highest acquisition depth.",
  ...
  "skills.termination": "Completion timing",
